...
\begin{table}[h]
  ...
  \textbf{Unique Features} & \RaggedRight{Inpainting, outpainting, image-to-image & Excellent prompt adherence, detailed outputs & High-quality photorealistic synthesis, noise robust} \\ \hline
  \end{tabular}
  \caption{Comparison of Stable Diffusion, FLUX.1, and Kwai-Kolors}
  \end{table}
